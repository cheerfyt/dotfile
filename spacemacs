...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Envy Code R VS"
                               :size 13.5
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
